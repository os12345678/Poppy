...
let type_program (Ast.Prog (struct_defns, trait_defns, method_defns, function_defns, main_expr)) = 
  ...
  (* let%bind typed__defns = Type_method.type_method_defns  *)
  let%bind typed_method_defns = Type_method.type_method_defns struct_defns trait_defns method_defns function_defns in
